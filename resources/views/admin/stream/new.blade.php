                ...
                <div class="row">
                    <div class="col-xl-12 col-xxl-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form class="p-3" action="{{route('admin.stream.postCreate')}}" method="post" enctype="multipart/form-data" id="form">
                                    @csrf
                                        ...
                                        <div class="row">
                                            <div class="col-12 mb-2">
													<div class="form-group">
                                                        ...
                                                        <textarea class="form-control" name="description" id="textEditor" cols="30" rows="100" required>{{old('description') ?? ''}}</textarea>
                                                    </div>
                                            </div>
                                            <div class="col-12 mb-2">
                                                <div class="form-group">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" name="link" value="{{old('link') ?? ''}}" id="link" required>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>

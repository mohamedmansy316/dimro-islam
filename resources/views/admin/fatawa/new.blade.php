                    ...
                    <div class="col-xl-12 col-xxl-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Add new fatawa</h4>
                            </div>
                            <div class="card-body">
                                <form class="p-3" action="{{route('admin.fatawa.postCreate')}}" method="post" enctype="multipart/form-data" id="form">
                                    @csrf
									<div class="tab-content">
                                        ...
                                        <button type="submit" class="btn btn-primary">Add Fatwa</button>
                                    </div>
                                </form>
                            </div>
                        </div>

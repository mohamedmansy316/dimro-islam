...
<body>
            ...
            <div class="container">
                <div class="row text-center">
                    ...
                    <p class="text-white">Lorem Ipsum is simply dummy text of the printing and typesetting industry.
                        ...
                        printer took a galley of type and scrambled it to make a type specimen audio. It has survived not
        ...
        <section id="categories" class="pt-3">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <a href="{{route('index')}}"><i class="fa-solid fa-house"></i> &nbsp;>&nbsp; </a><a href="{{route('AllSubjects.get')}}">Subjects > </a> <a href="{{route('audios.all')}}"> Audios &nbsp; > </a>
                    </div>
                    <div class="col-12">
                        <div class="mt-3">
                                        ...
                                        @forelse ($AllAudios as $Audio)
                                            <article class="subject px-3 rounded-3">
                                                <div class="subject-main">
                                                    <header>
                                                        <h3 class=""><a href="{{route('audios.single', $Audio->id)}}">{{ $Audio->title }}</a></h3>
                                                    </header>
                                                    @if ($Audio->author->name != 'Deleted Author')
                                                    <p>{{ $Audio->author->name }}</p>
                                                    @endif
                                                    @if ($Audio->Category->title != 'Deleted Category')
                                                    <p>Category: <b><a href="">{{ $Audio->Category->title }}</a></b></p>
                                                    @endif
                                                </div>
                                                <div class="subject-photo">
                                                <img class="rounded-2" src="{{ $Audio->AudioImage }}" alt="">
                                                </div>
                                            </article>
                                        @empty
                                        @endforelse
            ...
            <div class="container">
                <div class="footer-top-style-3 pb-75">
                    ...
                    <div class="social-icon social-icon-center">
                        ...
                        <a href="#"><i class="icon-social-faceaudio-square"></i></a>
                    </div>
